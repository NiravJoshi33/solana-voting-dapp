...
export const getVotingProgram = (provider: AnchorProvider, address?: PublicKey): Program<Voting> => {
...
export const canUserAddCandidate = async (program: Program<Voting>, pollId: number, publicKey: PublicKey) => {
  const [pollPda] = PublicKey.findProgramAddressSync(
